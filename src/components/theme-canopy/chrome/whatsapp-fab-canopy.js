...
export function WhatsAppFabCanopy() {
  ...
  return (
    <div className="fixed right-5 z-40 flex flex-col items-end gap-2 md:right-6" style={{ bottom }}>
      <AnimatePresence>
        {pulse && (
          <motion.span
            ...
            exit={{ opacity: 0, y: 4 }}
            className="rounded-full bg-canopy-deep px-3 py-1.5 text-xs font-semibold text-canopy-mist shadow-soft"
          >
            Chat on WhatsApp
          </motion.span>
        )}
